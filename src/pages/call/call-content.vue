      ...
      <div class="volunteer">
        ...
        <div class="volunteer-img">
          ...
          <el-dialog
            ...
            :visible.sync="dialog"
            width="896px">
            <el-form ref="personform" :label-position="labelPosition" label-width="80px" :model="personform"  :rules="personrules">
      ...
      data: function () {
        ...
        return {
          ...
          rules: {
            ...
            phone: [
              { required: true, message: '联系方式不为空', trigger: 'blur' },
          ...
          personrules: {
            ...
            sex: [
              { required: true, message: '性别不为空', trigger: 'change' }
            ],
            job: [
              { required: true, message: '职业不为空', trigger: 'blur' }
            ],
            city: [
              { required: true, message: '所在城市不为空', trigger: 'blur' }
            ],
            phone: [
             { required: true, message: '联系方式不为空', trigger: 'blur' },
             { validator: checkPhone, trigger: 'blur' }
